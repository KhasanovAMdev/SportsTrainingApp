...
--
-- Name: workout_stats; Type: TABLE; Schema: dbo; Owner: KhasanovAM
--

CREATE TABLE dbo.workout_stats (
    id integer NOT NULL,
    workout_id integer,
...
ALTER TABLE dbo.workout_stats OWNER TO "KhasanovAM";

--
-- Name: workout_stats_id_seq; Type: SEQUENCE; Schema: dbo; Owner: KhasanovAM
--

CREATE SEQUENCE dbo.workout_stats_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE dbo.workout_stats_id_seq OWNER TO "KhasanovAM";

--
-- Name: workout_stats_id_seq; Type: SEQUENCE OWNED BY; Schema: dbo; Owner: KhasanovAM
--

ALTER SEQUENCE dbo.workout_stats_id_seq OWNED BY dbo.workout_stats.id;
...
--
-- Name: workout_stats id; Type: DEFAULT; Schema: dbo; Owner: KhasanovAM
--

ALTER TABLE ONLY dbo.workout_stats ALTER COLUMN id SET DEFAULT nextval('dbo.workout_stats_id_seq'::regclass);
...
--
-- Name: workout_stats workout_stats_pkey; Type: CONSTRAINT; Schema: dbo; Owner: KhasanovAM
--

ALTER TABLE ONLY dbo.workout_stats
...
--
-- Name: workout_stats workout_stats_workout_id_fkey; Type: FK CONSTRAINT; Schema: dbo; Owner: KhasanovAM
--

ALTER TABLE ONLY dbo.workout_stats
    ADD CONSTRAINT workout_stats_workout_id_fkey FOREIGN KEY (workout_id) REFERENCES dbo.workouts(id) ON DELETE CASCADE;
